...
Компонент текстового поля в диалоге, сохраняющий введённое значение напрямую в `System table`. Поддерживает сброс до значения по умолчанию долгим нажатием.
